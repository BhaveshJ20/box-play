    ...
    MediaBox.prototype = {
        ...
        render: function (service) {
            ...
            lightbox = this.template(
                '<div class="mediabox-wrap" role="dialog" aria-hidden="false"><div class="mediabox-content" role="document" tabindex="0"><span id="mediabox-esc" class="mediabox-close" aria-label="close" tabindex="1"></span><iframe src="{embed}" frameborder="0" allowfullscreen></iframe></div></div>', {
                    embed: embedLink,
                    //params: urlParams
                });
