(function() {
  ...
  var rafActive = false
  // Container element
  var container = document.querySelector('.dont-let-wrap')
  ...
  // container.appendChild(fakeScroll)
  ...
  function updateAnimationImages () {
    ...
    images.forEach(function (image, index) {
      ...
      setTransform(image, 'perspective(500px) translateX('+ translateX +'px) rotateX('+ 0 +'deg) rotateY('+ 0 +'deg)')
    })
  }
